  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          <ContactRow name="Anita Sharma (Wife)" phone="+91 98765 11223" isPrimary />
          <View style={styles.divider} />
          <ContactRow name="Suresh Sharma (Brother)" phone="+91 98765 44556" />
          <View style={styles.divider} />
          <Pressable style={styles.addContactButton} onPress={() => Alert.alert('Add Contact', 'Emergency contact manager opened.')}>
...
function ContactRow({ name, phone, isPrimary }: { name: string; phone: string; isPrimary?: boolean }) {
  return (
