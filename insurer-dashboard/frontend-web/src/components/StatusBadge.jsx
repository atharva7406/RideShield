export default function StatusBadge({ status, size = 'md' }) {
  const styles = {
    ...
    MEDICAL_REPORT_PENDING:   'bg-[#fef3c7] text-[#92400e] border border-[#fde68a]',
    MEDICAL_REPORT_SUBMITTED: 'bg-[#dbeafe] text-[#1e40af] border border-[#bfdbfe]',
  ...
  const labels = {
    MEDICAL_REPORT_PENDING:   'Need Medical Report',
    MEDICAL_REPORT_SUBMITTED: 'Medical Report Submitted',
  ...
  const dots = {
    PENDING:                  '#727687',
    MEDICAL_REPORT_PENDING:   '#F59E0B',
    MEDICAL_REPORT_SUBMITTED: '#3B82F6',
    UNDER_REVIEW:             '#F59E0B',
    APPROVED:                 '#10B981',
    REJECTED:                 '#EF4444',
    ACTIVE:                   '#10B981',
  ...
  const labelText = labels[status] || status?.replace(/_/g, ' ');
