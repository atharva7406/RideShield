      ...
      <SafeAreaView style={styles.safe} edges={['top']}>
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.avatarSection}>
            ...
            <Text style={styles.userName}>{user?.fullName ?? 'mmm'}</Text>
            <Text style={styles.userPhone}>{user?.phone ?? '+15551234567'}</Text>

            <View style={styles.badgeRow}>
              <View style={styles.ratingBadge}>
                <Ionicons name="speedometer-outline" size={14} color="#ffffff" />
                <Text style={styles.ratingText}>0% Risk</Text>
              </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoValue}>
                {user?.vehicleType ? VehicleTypeLabels[user.vehicleType] : 'Two Wheeler (Bike/Scooter)'}
              </Text>
            </View>
          </View>
