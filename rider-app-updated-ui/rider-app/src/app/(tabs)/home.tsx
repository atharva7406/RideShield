      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.protectionSection}>
          <Text style={styles.sectionTitle}>
            ...
            {/* Item 1 - Vehicle Damage */}
            <View style={[styles.protectionCardAmber, !hasActiveShift && { opacity: 0.85 }]}>
              <View style={styles.protectionIconCircleAmber}>
                <Ionicons name="bicycle-outline" size={22} color="#ea580c" />
              </View>
              <View style={styles.protectionTextGroup}>
                <Text style={styles.protectionTitleAmber}>Vehicle Damage</Text>
                <Text style={styles.protectionDescAmber}>
                  {hasActiveShift 
              ...
              <Ionicons 
                ...
                size={22} 
                color={hasActiveShift ? "#ea580c" : "#fdba74"} 
              />
            </View>

            {/* Item 2 - Personal Accident & Medical */}
